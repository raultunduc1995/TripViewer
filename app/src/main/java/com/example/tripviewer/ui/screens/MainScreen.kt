package com.example.tripviewer.ui.screens
...
fun TripItem(
    ...
    Row(
        ...
        Column(modifier = Modifier.padding(horizontal = 8.dp)) {
            ...
            Text(
                text = resources.getString(R.string.end_time, endTime)
            )
            Text(
                text = resources.getString(
                    com.example.featurestripsdetails.R.string.start_city,
                    startCity
                )
            )
            Text(
                text = resources.getString(
                    com.example.featurestripsdetails.R.string.end_city,
                    endCity
                )
            )
        }
